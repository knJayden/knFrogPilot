...
class Controls:
  ...
  def state_control(self, CS):
    ...
    speed_check = CS.vEgo >= self.pause_lateral_below_speed
    ...
    CC.latActive = (self.active or self.FPCC.alwaysOnLateral) and signal_check and speed_check and not CS.steerFaultTemporary and not CS.steerFaultPermanent and \
